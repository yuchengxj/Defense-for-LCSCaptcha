...
def get_map_exp3(MINOVERLAP, draw_plot, typeCAP, typeFilter, score_threhold=0.5):
    print('==========  '+typeCAP+'  =====  '+typeFilter+'  =========')
    GT_PATH             = '/root/autodl-tmp/dachuang/数据集/ground_truth/'+typeCAP+'/'
    DR_PATH             = '/root/autodl-tmp/dachuang/数据集/detect_results_filter/'+typeCAP+'/ssd-vgg-'+typeFilter+'/'
    IMG_PATH            = '/root/autodl-tmp/dachuang/数据集/map_tmp/'+typeCAP+'/'+typeFilter+'/'
    TEMP_FILES_PATH     = os.path.join('/root/autodl-tmp/dachuang/数据集', '.temp_files')
    RESULTS_FILES_PATH  = os.path.join('/root/autodl-tmp/dachuang/数据集/map_exp3/'+typeCAP+'/'+typeFilter, 'results')
    if not os.path.exists('/root/autodl-tmp/dachuang/数据集/map_exp3/'+typeCAP+'/'+typeFilter):
        os.makedirs('/root/autodl-tmp/dachuang/数据集/map_exp3/'+typeCAP+'/'+typeFilter)
    if not os.path.exists('/root/autodl-tmp/dachuang/数据集/map_exp3/'+typeCAP+'/'+typeFilter):
        os.makedirs('/root/autodl-tmp/dachuang/数据集/map_exp3/'+typeCAP+'/'+typeFilter)
