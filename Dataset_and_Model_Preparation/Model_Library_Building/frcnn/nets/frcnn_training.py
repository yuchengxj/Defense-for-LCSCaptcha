...
class FasterRCNNTrainer(nn.Module):
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        for i in range(n):
            ...
            rpn_cls_loss = F.cross_entropy(rpn_score[gt_rpn_label==1], gt_rpn_label[gt_rpn_label==1], ignore_index=-1)
        ...
        for i in range(n):
            ...
            # print(gt_roi_label[gt_roi_label[:]==1].size())
            # print(roi_score[gt_roi_label[:]==1].size())
            # exit(0)
